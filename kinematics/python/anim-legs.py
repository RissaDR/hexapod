...
sys.path.append("/home/d15/Desktop/apps/blender-2.82a-linux64/modules/hexapod_robot_simulator_master/ik_solver")
...
anim_walk_gait(front, middle, side, coxia, femur, tibia, hip_stance, leg_stance, stepCount, hipSwing, liftSwing, percent_x, percent_z, rot_x, rot_y, gaitType, walkMode)
